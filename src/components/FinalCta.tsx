  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150vw] h-[150vw] md:w-[80vw] md:h-[80vw] bg-[radial-gradient(circle,rgba(0,255,255,0.15)_0%,rgba(138,43,226,0.1)_30%,rgba(0,0,0,1)_70%)] animate-[spin_30s_linear_infinite]" />
      ...
      <div className="relative z-10 text-center max-w-[1000px] mx-auto w-full flex flex-col items-center">
        ...
        <div className="cta-btn-wrap relative perspective-[1000px]">
          <button
            className="btn-premium px-16 py-8 text-2xl tracking-widest bg-white text-black hover:text-white hover:bg-transparent before:bg-gradient-to-r before:from-cyan-400 before:to-purple-600 shadow-[0_0_80px_rgba(0,255,255,0.4)] transition-all duration-500 group overflow-visible"
